...
| 0x4E(78)  | uint8  | PORT_SPI_HUB_SOCKET_SELECT   | RW            | SPIハブ機能によってソケットを選択します。無選択の場合は0とします。                                               |
| 0x4F(79)  | uint8  | PORT_SPI_HUB_PIN_SELECT      | RW            | SPIハブ機能で選択したソケットのピンを指定します。(0:PIN_SPI_SS, 1:PIN_SPI_SS_HUB)                                |
